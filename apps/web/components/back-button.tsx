...
export function BackButton() {
  ...
  const cls =
    'inline-flex items-center gap-2 min-h-[44px] rounded-lg border border-brand-borderStrong bg-brand-cardBg px-4 py-2 text-sm font-semibold text-brand-textActive shadow-sm hover:border-brand-burnt hover:text-brand-burnt hover:bg-brand-burnt/5 active:scale-[0.98] transition';
