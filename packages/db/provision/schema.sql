...
CREATE TYPE "public"."voter_gender" AS ENUM('M', 'F', 'U');--> statement-breakpoint
CREATE TYPE "public"."voter_registration_source" AS ENUM('iebc_register', 'campaign_collected', 'public_event', 'unknown');--> statement-breakpoint
CREATE TYPE "public"."flames_match_method" AS ENUM('phone', 'name', 'unmatched');--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "roads" (
	...
	"status" text,
	"funding" text,
	"mp_project" boolean DEFAULT true NOT NULL,
	"surface" text,
	"length_km" numeric,
	"notes" text,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "roads" ADD CONSTRAINT "roads_ward_id_wards_id_fk" FOREIGN KEY ("ward_id") REFERENCES "public"."wards"("id") ON DELETE set null ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "voters" ADD CONSTRAINT "voters_ward_id_wards_id_fk" FOREIGN KEY ("ward_id") REFERENCES "public"."wards"("id") ON DELETE restrict ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "voters" ADD CONSTRAINT "voters_polling_station_id_polling_stations_id_fk" FOREIGN KEY ("polling_station_id") REFERENCES "public"."polling_stations"("id") ON DELETE set null ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "flames_crew" ADD CONSTRAINT "flames_crew_ward_id_wards_id_fk" FOREIGN KEY ("ward_id") REFERENCES "public"."wards"("id") ON DELETE restrict ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "flames_crew" ADD CONSTRAINT "flames_crew_voter_id_voters_id_fk" FOREIGN KEY ("voter_id") REFERENCES "public"."voters"("id") ON DELETE set null ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "roads_ward_idx" ON "roads" USING btree ("ward_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "roads_from_idx" ON "roads" USING btree ("from_village_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "roads_to_idx" ON "roads" USING btree ("to_village_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "wards_constituency_idx" ON "wards" USING btree ("constituency_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "station_reports_type_idx" ON "station_reports" USING btree ("report_type");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "voters_ward_idx" ON "voters" USING btree ("ward_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "voters_polling_station_idx" ON "voters" USING btree ("polling_station_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "voters_surname_idx" ON "voters" USING btree ("surname");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "voters_gender_idx" ON "voters" USING btree ("gender");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "voters_dob_idx" ON "voters" USING btree ("date_of_birth");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "flames_crew_ward_idx" ON "flames_crew" USING btree ("ward_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "flames_crew_voter_idx" ON "flames_crew" USING btree ("voter_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "flames_crew_match_idx" ON "flames_crew" USING btree ("match_method");